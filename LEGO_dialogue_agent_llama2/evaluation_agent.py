...
tool_descriptions = {
    ...
    "Move to": "With this tool, users can designate a specific location within the virtual environment and seamlessly transport themselves to that chosen spot, enhancing navigation efficiency.",
    ...
    "Turn Left": "This tool facilitates a leftward rotation, allowing users to change their orientation in the virtual environment, enhancing situational awareness and exploration.",
    "Turn Right": "Similar to 'Turn Left,' this tool enables a rightward rotation, empowering users to adjust their perspective and navigate seamlessly within the virtual space.",
    "Look Up": "Allows users to gaze upwards in the virtual environment, facilitating a more immersive experience by exploring the details above eye level.",
    "Look Down": "This tool permits users to lower their viewpoint within the virtual environment, offering a comprehensive exploration of details at different levels.",
    "Pan Left": "Enables a smooth horizontal panning motion to the left, enhancing the user's ability to survey their surroundings or focus on specific points of interest.",
    "Pan Right": "Similar to 'Pan Left,' this tool initiates a horizontal panning motion to the right, offering users a flexible way to observe their surroundings and interact with virtual elements.",
    "Move Up": "Allows users to ascend vertically within the virtual environment, providing access to higher platforms or viewpoints for an enhanced interactive experience.",
    "Move Down": "This tool facilitates a controlled descent within the virtual space, enabling users to explore lower levels or adjust their position as needed.",
    "Double Forward": "Doubles the speed or distance covered when moving forward, providing a faster means of traversal for users who prefer a more rapid pace.",
    "Double Backward": "Similar to 'Double Forward,' this tool increases the speed or distance covered when moving backward, offering a quicker retreat or repositioning option.",
...
def setup_tools() -> List[StructuredTool]:
    ...
    for name, description in tool_descriptions.items():
        ...
        structured_tools.append(
            StructuredTool.from_function(func=func, name=name, description=description, args_schema=ToolInput))
