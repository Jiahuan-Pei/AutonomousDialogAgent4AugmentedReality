...
# output_directory = os.path.join(os.path.dirname(os.path.abspath(__file__)), "lego_instructions")
output_directory = os.path.join(os.path.dirname(os.getcwd()), "lego_instructions") # Parent dir of the current working dir
